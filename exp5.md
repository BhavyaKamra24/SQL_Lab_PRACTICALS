...
```SQL
MariaDB [bhavya]> SELECT COUNT(*) ENAME FROM EMPLOYEE;
+-------+
| ENAME |
+-------+
|    14 |
...
```SQL
MariaDB [bhavya]> SELECT SUM(SAL) AS TOTAL_SALARY FROM EMPLOYEE;
+--------------+
| TOTAL_SALARY |
+--------------+
|        29025 |
...
```SQL
MariaDB [bhavya]> SELECT MAX(SAL) AS MAX_SALARY FROM EMPLOYEE;
+------------+
| MAX_SALARY |
+------------+
|       5000 |
...
```SQL
MariaDB [bhavya]> SELECT MIN(SAL) AS MIN_SALARY FROM EMPLOYEE;
+------------+
| MIN_SALARY |
+------------+
|        800 |
...
```SQL
MariaDB [bhavya]> SELECT AVG(SAL) AS AVG_SALARY FROM EMPLOYEE;
+------------+
| AVG_SALARY |
+------------+
|  2073.2143 |
...
### ROUND VALUE
```SQL
MariaDB [bhavya]> SELECT ROUND(AVG(SAL),1) AS AVG_SALARY FROM EMPLOYEE;
+------------+
| AVG_SALARY |
+------------+
|     2073.2 |
...
```SQL
MariaDB [bhavya]> SELECT MIN(SAL)  AS MIN_SAL FROM EMPLOYEE
    -> WHERE JOB ='SALESMAN';
+---------+
| MIN_SAL |
+---------+
...
```SQL
MariaDB [bhavya]> SELECT SUM(SAL) AS SUM_SAL FROM EMPLOYEE
...
```SQL
MariaDB [bhavya]> SELECT UPPER(ENAME) FROM EMPLOYEE;
+--------------+
| UPPER(ENAME) |
+--------------+
| SMITH        |
...
```SQL
MariaDB [bhavya]> SELECT LOWER(ENAME) FROM EMPLOYEE;
+--------------+
| LOWER(ENAME) |
+--------------+
| smith        |
...
```SQL
MariaDB [bhavya]> SELECT CONCAT(UPPER(SUBSTR(ENAME,1,1)),LOWER(SUBSTR(ENAME,2))) FROM EMPLOYEE;
+---------------------------------------------------------+
...
```SQL
MariaDB [bhavya]> SELECT LENGTH(ENAME) FROM EMPLOYEE;
+---------------+
| LENGTH(ENAME) |
+---------------+
|             5 |
